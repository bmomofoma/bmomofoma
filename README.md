...
### 🚀 Featured Project
* **[ESP32-S3 Sensor Hub / MRCU Rev A](PASTE_YOUR_PROJECT_REPO_LINK_HERE):** A 4-layer sensor hub designed to aggregate local environmental and inertial data. It maps out a unified I2C bus for five distinct onboard sensors, handles hardware-level boot constraints, and integrates native USB-JTAG debugging.
