...
* **[I2C Protocol Decoder](https://github.com/bmomofoma/I2C-Protocol-Decoder):** A C++ verification tool designed to parse raw CSV bus logs into human-readable protocol transactions. Implements a finite state machine to validate Start/Stop conditions, address frames, and ACK/NACK bits, streamlining the debugging of custom FPGA-based I2C masters.

 ### 🚧 Work in Progress (Fall 2026)
